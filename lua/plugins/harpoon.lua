return {
    ...
    config = function()
        ...
        keymap.set("n", "<C-j>", function() harpoon:list():select(1) end)
        keymap.set("n", "<C-k>", function() harpoon:list():select(2) end)
        keymap.set("n", "<C-l>", function() harpoon:list():select(3) end)
        keymap.set("n", "<C-h>", function() harpoon:list():select(4) end)
